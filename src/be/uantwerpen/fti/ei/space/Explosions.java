...
/**
 * This class is used to control the explosions created by collisions between enemies and player bullets and the sound.
 * @author Bavo Lesy
 * @version 1.0
 */
public abstract class Explosions extends Entity{
    ...
    public Explosions() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        this.sound = new SoundComponent("explosion");
        this.updateSound = new SoundSystem(sound);
    }
    /**
     * This method is used to play the sound.
     * @return sound of the explosions.
     */
